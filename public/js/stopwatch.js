...
let list = [
    {name: 'Reading', id: 'readingTime'}, {name: 'Thinking', id: 'thinkingTime'}, {
        name: 'Coding',
        id: 'codingTime'
    }, {'name': 'Debug', id: 'debugTime'}, {name: '', id: ''}
]
...
var startStopButtonEvent = function () {
    if (!stopwatch.running()) {
        ...
        resetLapButton.innerHTML = list[lapCount]['name'];
        stopwatch.start();
    } else {
        replaceClass(startStopButton, 'stop-button', 'start-button');
        replaceClass(resetLapButton, 'lap-button', 'reset-button');
